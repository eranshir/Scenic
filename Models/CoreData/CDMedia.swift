...
extension CDMedia {
    func toMedia() -> Media {
        Media(
            ...
            device: device,
            lens: lens,
            focalLengthMM: focalLengthMMOptional,
            aperture: apertureOptional,
            shutterSpeed: shutterSpeed,
            iso: isoOptional,
            resolutionWidth: resolutionWidthOptional,
            resolutionHeight: resolutionHeightOptional,
            presets: presets,
            filters: filters,
            headingFromExif: headingFromExif,
    ...
    func updateFromMedia(_ media: Media) {
        ...
        captureTimeUTC = media.captureTimeUTC
        setExifData(media.exifData)
        device = media.device
        lens = media.lens
        focalLengthMMOptional = media.focalLengthMM
        apertureOptional = media.aperture
        shutterSpeed = media.shutterSpeed
        isoOptional = media.iso
        resolutionWidthOptional = media.resolutionWidth
        resolutionHeightOptional = media.resolutionHeight
        presets = media.presets
        filters = media.filters
        headingFromExif = media.headingFromExif
    ...
    static func fromMedia(_ media: Media, in context: NSManagedObjectContext) -> CDMedia {
        ...
        cdMedia.isDownloaded = true // Local media is always "downloaded"
